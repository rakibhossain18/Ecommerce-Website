    ...
    <div class="search-product">
        ...
        <table  width="100%"  height="150px">
            <tr>
                ...
                <td width="40%">
                    <h3><a href="product-details.php?id=<?php echo $row['ID'] ;?> "> <?php echo $row['Product_Name']; ?></a> <br>Model No:  <?php echo $row['Model_No']; ?> <br>Tk : Tk : <?php echo $row['Product_Price']; ?> </h3>
                </td>
                <td width="10%">
                </td>
                <td width="25%">
                    <!-- <a href="#"> Wishlist</a> -->
                    <a href="#"><img class=""  src="images/wishlist-icon.png" style="margin: -10px";>. Save to Wishlist</a>
                    <br>
                    <br>
